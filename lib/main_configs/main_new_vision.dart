...
void main() {
  mainCommonBase(FlavorConfig()
    ..appName = "New Vision Infra"
    ..flavourName = 'nv'
    ..appEndName = {
      AppEndName.items: "random.api.dev/items",
      AppEndName.details: "random.api.dev/item"
    }
    ..itemSplash = "assets/images/nv_splash.png"
    ..itemLocation = "assets/app_icon/nv_logo.png"

/*      ..themeData = ThemeData.light().copyWith(
        primaryColor: Color(0xFFA5C655),
        appBarTheme: ThemeData.light().appBarTheme.copyWith(
          backgroundColor: Color(0xFF488A4C),
        ),
      ),*/
    ..themeData = ThemeData(
      primaryColor: Color(0xFFA5C655),
